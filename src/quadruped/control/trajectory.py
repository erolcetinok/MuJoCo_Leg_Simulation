...
References:
- mjbots: Improved swing trajectory
  https://blog.mjbots.com/2020/06/05/improved-swing-trajectory/
...
- Step Trajectory and Gait Planner from MIT Cheetah (Hackaday)
...
- pat92fr/FootTrajectoryPlanner
  https://github.com/pat92fr/FootTrajectoryPlanner
- Reduced-jerk 5-3-5 spline trajectory planning
  https://www.researchgate.net/publication/282267415_Reduced_jerk_joint_space_trajectory_planning_method_using_5-3-5_spline_for_robot_manipulators
...
class SwingFootTrajectory:
    """Bézier swing-foot trajectory: cubic in X/Y, two stitched cubics in Z meeting at apex_height (s=0.5)."""
...
class StanceFootTrajectory:
    """Linear stance-foot trajectory: foot translates at -body_velocity in body frame; Z held constant."""
